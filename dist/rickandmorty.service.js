...
let RickAndMortyService = class RickAndMortyService {
    ...
    async findAll() {
        const { data } = await (0, rxjs_1.firstValueFrom)(this.httpService.get('https://rickandmortyapi.com/api').pipe((0, rxjs_1.catchError)((error) => {
            throw 'Ops!';
        })));
        return data;
    }
...
//# sourceMappingURL=rickandmorty.service.js.map