...
let UpdateUserInput = class UpdateUserInput {
    static _GRAPHQL_METADATA_FACTORY() {
        return { name: { nullable: true, type: () => String }, email: { nullable: true, type: () => String }, password: { nullable: true, type: () => String } };
    }
};
exports.UpdateUserInput = UpdateUserInput;
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'cant be blank' }),
